...
class PHPShark_AdminPageFramework_WPUtility_URL extends PHPShark_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(PHPShark_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(PHPShark_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = PHPShark_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
    ...
    class PHPShark_AdminPageFramework_WPUtility_HTML extends PHPShark_AdminPageFramework_WPUtility_URL {
    ...
    class PHPShark_AdminPageFramework_WPUtility_Page extends PHPShark_AdminPageFramework_WPUtility_HTML {
    ...
    class PHPShark_AdminPageFramework_WPUtility_Hook extends PHPShark_AdminPageFramework_WPUtility_Page {
    ...
    class PHPShark_AdminPageFramework_WPUtility_File extends PHPShark_AdminPageFramework_WPUtility_Hook {
    ...
    class PHPShark_AdminPageFramework_WPUtility_Option extends PHPShark_AdminPageFramework_WPUtility_File {
    ...
    class PHPShark_AdminPageFramework_WPUtility_Meta extends PHPShark_AdminPageFramework_WPUtility_Option {
    ...
    class PHPShark_AdminPageFramework_WPUtility_SiteInformation extends PHPShark_AdminPageFramework_WPUtility_Meta {
    ...
    class PHPShark_AdminPageFramework_WPUtility_SystemInformation extends PHPShark_AdminPageFramework_WPUtility_SiteInformation {
    ...
    class PHPShark_AdminPageFramework_WPUtility extends PHPShark_AdminPageFramework_WPUtility_SystemInformation {
